package pageutil_test

import (
	"sort"
	"testing"

	"github.com/wangweihong/eazycloud/pkg/util/pageutil"
...
func TestPaging(t *testing.T) {
	Convey("", t, func() {
		s, e := pageutil.PagingIndex(0, 0, 0)
		So(s, ShouldEqual, 0)
		So(e, ShouldEqual, 0)

		s, e = pageutil.PagingIndex(0, -1, 0)
		So(s, ShouldEqual, 0)
		So(e, ShouldEqual, 0)

		s, e = pageutil.PagingIndex(10, -1, 0)
		So(s, ShouldEqual, 0)
		So(e, ShouldEqual, 10)

		s, e = pageutil.PagingIndex(10, -1, 5)
		So(s, ShouldEqual, 0)
		So(e, ShouldEqual, 5)

		s, e = pageutil.PagingIndex(10, 0, 5)
		So(s, ShouldEqual, 0)
		So(e, ShouldEqual, 5)
		...
		s, e = pageutil.PagingIndex(10, 2, 5)
		So(s, ShouldEqual, 10)
		So(e, ShouldEqual, 10)
	})
}
...
func TestCombinePaging(t *testing.T) {
	Convey("组合分页，组合两种不同类型进行分页", t, func() {
		...
		s, e := pageutil.PagingIndex(len(combinedItems), 0, 3)
