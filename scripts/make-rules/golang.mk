...
EXCLUDE_TESTS=$(ROOT_PACKAGE)/test $(ROOT_PACKAGE)/pkg/log $(ROOT_PACKAGE)/third_party $(ROOT_PACKAGE)/internal/pump/storage $(ROOT_PACKAGE)/internal/pump $(ROOT_PACKAGE)/internal/pkg/logger
